					...
					<div class="row">
						<div class="col-md-12">
							<div class="card shadow">
								...
								<div class="card-body">
									<form action="<?= base_url('barang/proses_reorder/' . $barang->kode_barang) ?>" id="form-tambah" method="POST">
										<div class="form-row">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												...
												<input type="number" name="stok_keluar" placeholder="Masukkan Stok Keluar" autocomplete="off" class="form-control" required value="<?= $barang->stok_keluar ?>" readonly>
											</div>
											<div class="form-group col-md-6">
