					...
					<div class="row">
						<div class="col-md-12">
							<div class="card shadow">
								...
								<div class="card-body">
									<form action="<?= base_url('customer/detailreport/' . $customer->kode) ?>" id="form-tambah" method="POST">
										<div class="form-row">
									...
									<div class="form-group col-md-4">
											<a href="<?= base_url('customer/detailbarang/' . $customer->nama) ?>" class="btn btn-primary btn-sm"><i class="fa"></i>&nbsp;&nbsp;Lihat Detail Barang</a>									
											</div>
								</div>
							</div>
						</div>
