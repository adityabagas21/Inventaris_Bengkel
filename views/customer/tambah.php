								...
								<div class="card-body">
									<form action="<?= base_url('customer/proses_tambah') ?>" id="form-tambah" method="POST">
										...
										<div class="form-group col-md-6">
												<label for="no_antre"><strong>No Antrian</strong></label>
												<input type="text" name="no_antre" placeholder="Nomor Antrian" autocomplete="off" class="form-control" required value=""maxlength="8" readonly>
											</div>
											<div class="form-group col-md-6">
										...
										<div class="form-row">									
											<div class="form-group col-md-6">
												...
												<input type="text" name="no_polisi" placeholder="Masukkan Nomor Polisi" autocomplete="off" class="form-control" required>
											</div>
											<div class="form-group col-md-6">
												<label for="no_rangka"><strong>Nomor Rangka</strong></label>
												<input type="text" name="no_rangka" placeholder="Masukkan Nomor Rangka" autocomplete="off" class="form-control" required>
											</div>
											<div class="form-group col-md-6">
												<label for="no_mesin"><strong>Nomor Mesin</strong></label>
												<input type="text" name="no_mesin" placeholder="Masukkan Nomor Mesin" autocomplete="off" class="form-control" required>
											</div>
											<div class="form-group col-md-6">
												<label for="tipe_mobil"><strong>Tipe Mobil</strong></label>
												<input type="text" id="tipe_mobil" name="tipe_mobil" placeholder="Masukkan Tipe Mobil" autocomplete="off" class="form-control" required  maxlength="20">
											</div>
											<div class="form-group col-md-6">
												<label for="keterangan"><strong>Keterangan</strong></label>
												<textarea type="text" id="keterangan" name="keterangan" rows="4" cols="50" placeholder="Masukkan Keterangan" autocomplete="off" class="form-control" required  maxlength="500"></textarea>
											</div>
										</div>
