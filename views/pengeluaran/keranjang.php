...
<td class="no_antre">
		<?= $this->input->post('no_antre') ?>
		<input type="hidden" name="no_antre_hidden[]" value="<?= $this->input->post('no_antre') ?>">
	</td>
	...
	<td class="harga_satuan">
		...
		<input type="hidden" name="harga_satuan_hidden[]" value="<?= $this->input->post('harga_satuan') ?>">
	</td>
	<td class="sub_total">
